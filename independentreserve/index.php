<?php
    ...
    $primaryCode = array("xbt", "eth", "bch", "ltc", "xrp");

    $secondaryCodeList = array("usd","aud", "nzd");
    $secondaryCode = $secondaryCodeList[0];

    //ticker ini list marketnya
    $ticker = array();
    foreach ($primaryCode as $key) {
        $result = getData("https://api.independentreserve.com/Public/GetMarketSummary?primaryCurrencyCode=$key&secondaryCurrencyCode=$secondaryCode");
...
<head>
    ...
    <title>independentreserve Market</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
      <a class="navbar-brand" href="#">Independent Reserve Market</a>
            ...
            <table class="table table-striped table-bordered table-hover ">
                ...
                <?php $i = 1;
                    ...
                    foreach ($ticker as $key => $value) {
                        if($value == null || !isset($value->PrimaryCurrencyCode)){
                            continue;
                        }
                ?>
                    <tr scope="row">
                        <td scope="col"><?php echo $i; ?></td>
                        <td scope="col"><?php echo $value->PrimaryCurrencyCode; ?></td>
                        <td scope="col"><?php echo $value->PrimaryCurrencyCode; ?></td>
                        <td scope="col"><?php echo number_format((float)$value->DayHighestPrice, 9); ?></td>
                        <td scope="col"><?php echo number_format((float)$value->DayLowestPrice, 9); ?></td>
