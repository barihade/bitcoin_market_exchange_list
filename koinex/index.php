<?php
    ...
    $ticker = getData("https://koinex.in/api/ticker");
    if($ticker != null){
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
      <a class="navbar-brand" href="#">KOINEX</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#">Koinex<span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover ">
                ...
                <?php $i = 1;
                    ...
                    foreach ($ticker->stats as $key => $value) {
                        foreach ($value as $key2 => $value2) {
                ?>
                    <tr scope="row">
                        <td scope="col"><?php echo $i; ?></td>
                        <td scope="col"><?php echo $key2 . "_" . $key; ?></td>
                        <td scope="col"><?php echo $key2 . "_" . $key; ?></td>
                        <td scope="col"><?php echo number_format((float)$value2->highest_bid, 9); ?></td>
                        <td scope="col"><?php echo number_format((float)$value2->lowest_ask, 9); ?></td>
                        <td scope="col"><?php echo number_format((float)$value2->last_traded_price, 9); ?></td>
                    </tr>
                    <?php
                        }
                    $i++;  
