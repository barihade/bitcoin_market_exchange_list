<?php
    ...
    $ticker = getData("https://isx.is/api/stats");
    if($ticker != null){
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
      <a class="navbar-brand" href="/idax/">ISX Market</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo BASE_URL;?>/hotbit/">Hotbit<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo BASE_URL;?>/isx/">ISX<span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
            ...
            <table class="table table-striped table-bordered table-hover ">
                ...
                ?>
                    <tr scope="row">
                        ...
                        <td scope="col"><?php echo $value->market; ?></td>
                        <!-- ini menampilkan nama dari tiap ticker, ngambil dari currencies -->
                        <td scope="col"><?php echo $value->market; ?></td>
                        <td scope="col"><?php echo number_format((float)$value->max, 9); ?></td>
                        <td scope="col"><?php echo number_format((float)$value->min, 9); ?></td>
                        <td scope="col"><?php echo number_format((float)$value->last_price, 9); ?></td>
                    </tr>
                    <?php
                    $i++;   
                    }
