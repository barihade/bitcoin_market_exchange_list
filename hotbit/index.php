<?php
    ...
    $ticker = getData("https://api.hotbit.io/api/v1/allticker");
    if($ticker != null){
        $ticker = json_decode($ticker)->ticker;
    }
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
      <a class="navbar-brand" href="/idax/">Hotbit Market</a>
            ...
            <table class="table table-striped table-bordered table-hover ">
                ...
                ?>
                    <tr scope="row">
                        ...
                        <td scope="col"><?php echo $value->symbol; ?></td>
                        ...
                        <td scope="col"><?php echo number_format((float)$value->last, 9); ?></td>
                    </tr>
                    <?php
                    $i++;   
                    }
